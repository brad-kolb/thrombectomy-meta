...
#{set text(font: ("system-ui", "Segoe UI", "Roboto", "Helvetica", "Arial", "sans-serif", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji") , size: 9pt); table(
  ...
  table.header(table.cell(align: center, colspan: 10, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 1.25em , weight: "regular" , fill: rgb("#333333")); Table S1. Trial Characteristics],
    table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Trial], table.cell(align: bottom + right, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Year], table.cell(align: bottom + right, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); N (EVT)], table.cell(align: bottom + right, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); N (Control)], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Occlusion], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Time Window], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Population], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Primary Endpoint], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Key Feature], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Notes],),
  table.hline(),
...
position: top, 
[
Table S1. Characteristics of the 30 included randomized controlled trials.
]), 
...
#{set text(font: ("system-ui", "Segoe UI", "Roboto", "Helvetica", "Arial", "sans-serif", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji") , size: 8.25pt); table(
  ...
  table.header(table.cell(align: center, colspan: 8, fill: rgb("#ffffff"), stroke: (bottom: (paint: rgb("#d3d3d3"), thickness: 1.5pt)))[#set text(size: 1.25em , weight: "regular" , fill: rgb("#333333")); Table S2. Risk of Bias Assessment#text(size: 0.75em , style: "italic" , weight: "regular")[#super[1];]],
    table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Trial], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Random Sequence], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Allocation Concealment], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Blinding (Performance)], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Blinding (Detection)], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Attrition], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Selective Reporting], table.cell(align: bottom + left, fill: rgb("#f0f0f0"))[#set text(size: 1.0em , weight: "bold" , fill: rgb("#333333")); Other],),
  table.hline(),
  ...
  table.hline(),
  table.footer(table.cell(colspan: 8)[#text(size: 0.75em , style: "italic" , weight: "regular")[#super[1];] Green = Low risk; Red = High risk; Yellow = Unclear risk.],),
)}
], caption: figure.caption(
position: top, 
[
Table S2. Cochrane risk of bias assessment for the 30 included trials.
]), 
kind: "quarto-float-tbl", 
supplement: "Table", 
)
